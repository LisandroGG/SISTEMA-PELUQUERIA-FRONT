		...
		<div className="max-w-3xl mx-auto px-6 py-16 text-gray-800">
			...
			<section className="mb-6">
				...
				<p>
					...
					gestionar tus reservas de turnos, incluyendo nombre, fecha y hora del
					turno.
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<p>
					...
					terceros, salvo que sea necesario para cumplir con el servicio que has
					solicitado (por ejemplo, servicios de mensajería).
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<p>
					...
					reserva y cumplir con las obligaciones legales.
				</p>
			</section>
