...
const StepCompont = ({ children, step, stepSelected, className= "" }) => {
    return(
        <article aria-labelledby={step} className={`bg-white flex flex-col gap-4 border-gray-200 border-2 p-4 rounded-3xl w-[var(--container-sm)] md:w-[var(--container-md)] ${className}`}>
