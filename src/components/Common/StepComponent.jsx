...
const StepCompont = ({ children, step, stepSelected, className = "" }) => {
	return (
		<article
			...
			className={`bg-white animate-fadeInToRight flex flex-col gap-1 border-gray-200 border-2 p-4 rounded-3xl w-[var(--container-sm)] md:w-[var(--container-md)] ${className}`}
		>
